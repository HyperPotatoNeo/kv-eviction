...
def initialize_vllm(
    ...
    # The forked vLLM CuMem allocator used here is incompatible with
    # expandable_segments=True. Clear any inherited cluster default so the
    # Attention Matching baseline can initialize vLLM reliably.
