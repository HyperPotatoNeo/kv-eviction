...
#SBATCH -N 1
#SBATCH --output=/pscratch/sd/s/siddart2/kv-eviction/experiments/eval/results/slurm_%j.out
#SBATCH --error=/pscratch/sd/s/siddart2/kv-eviction/experiments/eval/results/slurm_%j.err
#SBATCH --job-name=kv-eval
