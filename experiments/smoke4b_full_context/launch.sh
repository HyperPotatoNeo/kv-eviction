#!/bin/bash
# Smoke #4b: 5-step full-context baseline (no compaction) for Smoke #4 comparison.
#
...
#   bash /pscratch/sd/s/siddart2/kv-eviction/experiments/smoke4b_full_context/launch.sh
set -e
...
EXP_DIR="$KV_DIR/experiments/smoke4b_full_context"
CONTAINER_IMAGE="docker.io/novaskyai/skyrl-train-ray-2.51.1-py3.12-cu12.8"
CONTAINER_INF="skyrl-smoke4b-inf"
CONTAINER_TRAIN="skyrl-smoke4b-train"

TOML_TEMPLATE="$EXP_DIR/rl_smoke4b.toml"
TOML_RESOLVED="$EXP_DIR/resolved_rl_smoke4b_${SLURM_JOB_ID:-local}.toml"
INF_TOML="$EXP_DIR/inference_smoke4b.toml"
...
echo "==========================================="
echo "Smoke #4b: 5-step stability run"
echo "==========================================="
