#!/bin/bash
# Smoke #4: multi-step stability run with KV compaction.
#
...
#   bash /pscratch/sd/s/siddart2/kv-eviction/experiments/smoke4_rl_stability_run/launch.sh
set -e
...
EXP_DIR="$KV_DIR/experiments/smoke4_rl_stability_run"
CONTAINER_IMAGE="docker.io/novaskyai/skyrl-train-ray-2.51.1-py3.12-cu12.8"
CONTAINER_INF="skyrl-smoke4-inf"
CONTAINER_TRAIN="skyrl-smoke4-train"

TOML_TEMPLATE="$EXP_DIR/rl_smoke4.toml"
TOML_RESOLVED="$EXP_DIR/resolved_rl_smoke4_${SLURM_JOB_ID:-local}.toml"
INF_TOML="$EXP_DIR/inference_smoke4.toml"
...
echo "==========================================="
echo "Smoke #4: 5-step stability run"
echo "==========================================="
